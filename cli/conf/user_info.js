...
exports.companySizeByLabel = exports.companySizes.reduce((acc, companySize) => ({
    ...acc,
...
exports.yearsOfExperienceRangeByLabel = exports.yearsOfExperienceRanges.reduce((acc, yearsOfExperienceRange) => ({
    ...acc,
