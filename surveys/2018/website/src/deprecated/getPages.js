...
/**
 * Take a section index and a subsection index
 * and return a full page object
 */
 ...
 * (comparing first two segments first,
 * and then falling back to comparing only first segment)
 */
