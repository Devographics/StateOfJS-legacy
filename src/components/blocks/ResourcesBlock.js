            ...
            return (
              <div key={resource.name} className="resource">
                ...
                <div className="resource-contents">
                  <h4 className="resource-title"><a onClick={() => trackClick(section, resource, 'text')} href={`${url}&utm_content=textlink`}>{resource.name}</a></h4>
                  <h5 className="resource-author">{resource.author}</h5>
                  <div className="resource-description" >{resource.description}</div>
                </div>
                <div className="resource-play">
                  <a onClick={() => trackClick(section, resource, 'play')} href={`${url}&utm_content=playlink`}><PlaySVG /></a>
                </div>
              </div>
              )
            }
