        ...
        <BarChart barSize={20} data={this.props.data} layout="vertical" barGap={5} margin={{ top: 0, right: 50, left: 20, bottom: 0 }} >
          <defs>
            <pattern id="cfwue" patternUnits="userSpaceOnUse" width="10" height="10">
              <path d="M 0,10 l 10,-10 M -2.5,2.5 l 5,-5 M 7.5,12.5 l 5,-5" strokeWidth="6" shapeRendering="auto" stroke="#9688E4" strokeLinecap="square" />
            </pattern>
          </defs>
          <YAxis dataKey="Option" interval={0} type="category" tickLine={false} tick={<Tick highlight={this.props.highlight}/>} axisLine={{ stroke: '#9688E4' }} />
