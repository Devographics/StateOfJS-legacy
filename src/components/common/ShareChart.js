...
const Twitter = ({ text, section }) => {
  return (
    <a onClick={trackShare('Twitter', section)} className="resp-sharing-button__link" href={`https://twitter.com/intent/tweet/?text=${encodeURIComponent(text)}`} target="_blank" aria-label="">
...
const Facebook = ({ link, section }) => {
  return (
    <a onClick={trackShare('Facebook', section)} className="resp-sharing-button__link" href={`https://facebook.com/sharer/sharer.php?u=${encodeURIComponent(link)}`} target="_blank" aria-label="">
...
const Email = ({ subject, body, section }) => {
  return (
    <a onClick={trackShare('Email', section)} className="resp-sharing-button__link" href={`mailto:?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`} target="_self" aria-label="">
