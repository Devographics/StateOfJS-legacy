    ...
    return (
      <div className="section section-narrow section-block spread-the-word">
        ...
        <div className="share-options">
          <Twitter text="The State Of JavaScript Survey: find out the most popular JavaScript technologies of 2017 http://stateofjs.com #stateofjs"/>
          <Facebook link="http://stateofjs.com"/>
          <Email subject="The State Of JavaScript" body="Find out the most popular JavaScript technologies of 2017: http://stateofjs.com"/>
        </div>
      </div> 
    )
  }
