            ...
            <ResponsiveContainer minHeight={400} width="100%">
                ...
                >
                    ...
                    <XAxis
                        ...
                        type="category"
                        tickLine={false}
                        axisLine={{ stroke: '#9688E4' }}
                    />
                    <YAxis
                        hide
                        type="number"
                        tickLine
                        axisLine={{ stroke: '#5ec6cc' }}
                        domain={[0, max(this.props.data.map(d => parseInt(d.Mentions, 10)))]}
                    />
                    <Bar
                        isAnimationActive={false}
                        dataKey="Value"
                        fill="url(#cfwue)"
                        label={<Label total={total} showPercent={this.props.showPercent} />}
                    />
                </BarChart>
            </ResponsiveContainer>
        )
