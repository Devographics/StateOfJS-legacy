...
export const getCurrentPage = pathname => {
    ...
    if (page.section.subPages) {
        const subSectionIndex = _.findIndex(
...
export const getPreviousPage = ({ section, sectionIndex, subSection, subSectionIndex }) => {
    let previousPage = {}
...
export const getNextPage = ({ section, sectionIndex, subSection, subSectionIndex }) => {
