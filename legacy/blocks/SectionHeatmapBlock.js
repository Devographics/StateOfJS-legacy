...
const heatmapNote = (
    <p className="chart-block-note">
        Note: “user” defined as people who picked “I've used it before, and would use it again”.{' '}
        <a href="https://en.wikipedia.org/wiki/Phi_coefficient">Phi coefficient</a> values go from
        -100 to +100, darker red indicates stronger positive correlation, darker blue indicates
